                                ...
                                <table class="table table-bordered table-md">
                                    <tbody>
                                        <tr>
                                            ...
                                            <th style="width: 350px;">Pajak Bumi dan Bangunan</th>
                                        ...
                                        @foreach ($pajaks as $key => $pajak)
                                            <tr>
                                                <td class="text-center">
                                                    {{ ($pajaks->currentPage() - 1) * $pajaks->perPage() + $key + 1 }}
                                                </td>
                                                <td>{{ $pajak->pajak }}</td>
                                                <td class="text-center">{{ $pajak->nilai }}</td>
                                                <td class="text-right">
                                                    <div class="d-flex justify-content-center">
                                                        ...
                                                        <form action="" method="POST" class="ml-2"
                                                            ...
                                                            <button class="btn btn-sm btn-danger btn-icon"
                                                                ...
                                                                data-confirm-yes="submitDel(<?= $pajak->id ?>)"
                                                                data-id="del-{{ $pajak->id }}">
