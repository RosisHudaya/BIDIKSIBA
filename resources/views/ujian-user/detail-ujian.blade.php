    ...
    <div class="col-md-11 d-flex mx-auto my-4">
        ...
        <div class="col-md-6">
            ...
            <div class="p-main pt-1 pb-3 px-3">
                ...
                <hr class="mt-0 mb-1 p-0">
                <div class="d-flex">
                    <p class="col-md-2 ml-4 mr-0 my-1 p-0 p-d">NISN</p>
                    <p class="m-1 p-d">: {{ $detail_ujians->nisn }}</p>
                </div>
                <div class="d-flex m-0">
                    <p class="col-md-2 ml-4 mr-0 my-1 p-0 p-d">Nama</p>
                    <p class="m-1 p-d" style="text-transform: uppercase;">: {{ $detail_ujians->nama }}</p>
                </div>
                <div class="d-flex">
                    <p class="col-md-2 ml-4 mr-0 my-1 p-0 p-d">Sesi</p>
                    <p class="m-1 p-d">: {{ $detail_ujians->nama_sesi }}</p>
                </div>
                <div class="d-flex">
                    <p class="col-md-2 ml-4 mr-0 my-1 p-0 p-d">MulaiI</p>
                    <p class="m-1 p-d">: {{ \Carbon\Carbon::parse($detail_ujians->waktu_mulai)->format('d F Y H:i:s') }}</p>
                </div>
                <div class="d-flex">
                    <p class="col-md-2 ml-4 mr-0 my-1 p-0 p-d">Selesai</p>
                    <p class="m-1 p-d">: {{ \Carbon\Carbon::parse($detail_ujians->waktu_akhir)->format('d F Y H:i:s') }}</p>
                </div>
                <div class="d-flex">
                    <p class="col-md-2 ml-4 mr-0 my-1 p-0 p-d">Soal</p>
                    <p class="m-1 p-d">: {{ $jumlah_soal_ujian }}</p>
                </div>
                <div class="d-flex">
                    <p class="col-md-2 ml-4 mr-0 my-1 p-0 p-d">Waktu</p>
