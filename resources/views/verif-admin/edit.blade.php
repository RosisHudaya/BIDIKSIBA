...
@section('content')
    <section class="section">
        ...
        <div class="section-body">
            <div class="card">
                <form action="{{ route('verifikasi-pendaftar.update', $biodata) }}" method="POST"
                    ...
                    <div class="card-body m-0 p-0">
                        ...
                        <div class="form-group col-md-12 d-flex justify-content-start">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control @error('detail_pekerjaan') is-invalid @enderror"
                                    ...
                                    value="{{ $biodata_spk ? $biodata_spk->detail_pekerjaan : '' }}"
                        ...
                        <div class="form-group col-md-12 d-flex justify-content-start">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                @endif
                                <br><br>
                                <input class="form-control @error('shm') is-invalid @enderror" name="shm"
                                    id="shm" type="file">
                                @error('shm')
                                    <div class="invalid-feedback feed ml-3">
                                        {{ $message }}
                        ...
                        <div class="form-group col-md-12 d-flex justify-content-start">
                            <div class="form-group col-md-6">
                                ...
                                @endif
                                <br><br>
                                <input class="form-control @error('sdr') is-invalid @enderror" name="sdr"
                                    id="sdr" type="file">
                                @error('sdr')
                                    <div class="invalid-feedback feed ml-3">
                                        {{ $message }}
