            ...
            <table class="table table-bordered table-md">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ \Carbon\Carbon::parse($sesi_ujian->waktu_mulai)->formatLocalized('%d %B %Y %H:%M:%S') }}</td>
                    </tr>
                    <tr>
                        <th class="th-test" style="width: 300px;">SELESAI</th>
                        <td>{{ \Carbon\Carbon::parse($sesi_ujian->waktu_akhir)->formatLocalized('%d %B %Y %H:%M:%S') }}</td>
                    </tr>
                </tbody>
            </table>
