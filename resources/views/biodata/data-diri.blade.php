    ...
    <div class="py-3">
        <div class="form-group col-md-12 d-flex justify-content-start">
            <div class="form-group col-md-6">
                ...
                @if ($biodatas)
                    @if ($biodatas->foto)
                        <img id="foto-preview" class="mb-3 ml-3" src="{{ asset('storage/' . $biodatas->foto) }}"
                ...
                <input type="file" id="foto" class="form-control @error('foto') is-invalid @enderror"
                    name="foto" accept="image/*" {{ $biodatas?->status == 'Diverifikasi' ? 'disabled' : '' }}>
                @error('foto')
        ...
        <div class="form-group col-md-12 d-flex justify-content-start">
            <div class="form-group col-md-6">
                ...
                @if ($biodatas)
                    @if ($biodatas->ktp)
                        <img class="ml-3 mb-2" id="ktp-preview" src="{{ asset('storage/' . $biodatas->ktp) }}"
                            alt="ktp" style="width: 350px; height: 150px; object-fit: contain;">
                ...
                @else
                    ...
                    <p class="ml-4 mb-2 m-0 p-0 text-c">* Ekstensi (.png, .jpg, atau .jpeg)</p>
                @endif
                <input type="file" id="ktp" class="form-control @error('ktp') is-invalid @enderror"
                    name="ktp" accept="image/*" {{ $biodatas?->status == 'Diverifikasi' ? 'disabled' : '' }}>
                @error('ktp')
                    <div class="invalid-feedback feed ml-3">
                        {{ $message }}
                    </div>
            ...
            <div class="form-group col-md-6">
                ...
                @if ($biodatas)
                    @if ($biodatas->kartu_siswa)
                        <img class="ml-3 mb-2" id="kartu-siswa-preview"
                            src="{{ asset('storage/' . $biodatas->kartu_siswa) }}" alt="kartu-siswa"
        ...
        <div class="form-group col-md-12 d-flex justify-content-start">
            <div class="form-group col-md-6">
                ...
                @if ($biodatas)
                    @if ($biodatas->kk)
                        <img class="ml-3 mb-2" id="kk-preview" src="{{ asset('storage/' . $biodatas->kk) }}"
                            alt="kk" style="width: 350px; height: 150px; object-fit: contain;">
                        <p class="ml-4 m-0 p-0 text-b">* Ukuran file maksimal 2 MB (2048 KB)</p>
                        <p class="ml-4 mb-2 m-0 p-0 text-b">* Ekstensi (.png, .jpg, atau .jpeg)</p>
                    @else
                ...
                @else
                    ...
                    <p class="ml-4 mb-2 m-0 p-0 text-c">* Ekstensi (.png, .jpg, atau .jpeg)</p>
                @endif
                <input type="file" id="kk" class="form-control @error('kk') is-invalid @enderror"
                    name="kk" accept="image/*" {{ $biodatas?->status == 'Diverifikasi' ? 'disabled' : '' }}>
                @error('kk')
                    <div class="invalid-feedback feed ml-3">
                        {{ $message }}
                    </div>
        ...
        <div class="form-group col-md-12 d-flex">
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control @error('nik') is-invalid @enderror" id="nik"
                    ...
                    placeholder="masukkan nik anda" {{ $biodatas?->status == 'Diverifikasi' ? 'disabled' : '' }}>
                @error('nik')
                    <div class="invalid-feedback feed ml-3">
                        {{ $message }}
                    </div>
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control @error('nisn') is-invalid @enderror" id="nisn"
                    ...
                    placeholder="masukkan nisn anda" {{ $biodatas?->status == 'Diverifikasi' ? 'disabled' : '' }}>
                @error('nisn')
                    <div class="invalid-feedback feed ml-3">
                        {{ $message }}
                    </div>
