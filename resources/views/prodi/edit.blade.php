...
@section('content')
    <section class="section">
        ...
        <div class="section-body">
            <div class="card">
                <form action="{{ route('program-studi.update', $prodi) }}" method="POST">
                    <div class="card-header">
                        <h4>Validasi Edit Data Program Studi</h4>
                    </div>
                    <div class="card-body">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            ...
                            <select class="form-control select2 @error('id_jurusan') is-invalid @enderror" name="id_jurusan"
                                ...
                                @foreach ($jurusans as $jurusan)
                                    <option @selected($jurusan->id == $prodi->id_jurusan) value="{{ $jurusan->id }}"
