                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="header ml-4 mt-3">
                            <a class="btn btn-success" href="{{ route('export.hasil-spk') }}">
                                <i class="fas fa-file-csv"></i> Export
                            </a>
                        </div>
                        <div class="card-body">
                            <form id="search" method="GET" action="{{ route('menu-ranking.data-spk') }}">
                                <div class="d-flex mb-3 d-search">
                                    ...
                                    <a class="btn btn-secondary py-2 px-4" href="{{ route('menu-ranking.data-spk') }}">
                                        Reset
                                    </a>
                                </div>
                            </form>
                                ...
                                <table class="table table-bordered table-md">
                                    <tbody>
                                        <tr>
                                            ...
                                            <th class="text-center align-middle" style="width: 10%;">NILAI UJIAN</th>
                                            <th class="align-middle" style="width: 10%;">RANKING</th>
                                        </tr>
                                        @foreach ($results as $key => $result)
                                            ...
                                            @include('hasil-ranking.data-spk.detail')
                                        @endforeach
                                    </tbody>
                                </table>
                            </div>
